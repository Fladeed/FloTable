...
const config: Config = {
  ...
  url: 'https://your-flo-table-docs.vercel.app',
  ...
  organizationName: 'Fladeed', // Usually your GitHub org/user name.
  projectName: 'flo-table-with-views', // Usually your repo name.
